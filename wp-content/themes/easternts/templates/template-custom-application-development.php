<?php
/*
Template Name: Custom Application Development
*/
?>
    ...
    <div class="firebaseApp">
        <div class="">
            <div class="row text-center">
                <!-- <div class="">
                    <img src="https://www.easternts.com.au/wp-content/uploads/2019/05/App-Development.jpg" alt="">
                </div> -->
                <div class="serimg">
                    <div class="sercon ">
    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-8 gainCOmp ">
                <h3>Have your application designed your way!</h3>
            </div>
...
<section class="sectionPadd" style="background-color: #F2F2F2;">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
        ...
        <div class="row value_benifit_wrap ">
            <div class="col-md-4 col-sm-6 mb-5">
                <div class="outer">
                    ...
                    <p>Our team of QA experts have hands-on experience in all major types of testing, including functionality, usability, load, stress, acceptance, integration testing and more.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-5">
                <div class="outer">
                    ...
                    <p>Our team relies heavily on continuous integration and delivery. We often merge code changes into a central shared repository and run automated unit tests to get up close and fix bugs early.</p>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-5">
                <div class="outer">
                    ...
                    <p>We have developed a comprehensive approach to security and privacy in several areas, and constantly optimize it to meet the most demanding requirements and regulations.</p>
                </div>
            </div>
		</div>
      </div>
            ...
            <div class="col-md-6">
                <div class="accordion__item accordion__item--active">
                    <button class="accordion__btn">
                        ...
                        <span class="accordion__caption"><i class="far fa-hand-point-right"></i>Microservice Architecture</span>
                        <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                    </button>

                    <div class="accordion__content ">
                        <p class="">This architecture allows continuous delivery for complex development.</p>
                    </div>
                </div>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        ...
                        <span class="accordion__caption"><i class="far fa-hand-point-right"></i>N-Tier Architecture</span>
                        <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                    </button>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        ...
                        <span class="accordion__caption"><i class="far fa-hand-point-right"></i>Onion Architecture</span>
                        <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                    </button>
            ...
            <div class="col-lg-12 services-list-fresh cover-all-industries-mobile-aap-development">
                <ul>
                    <li>
                        ...
                        <h3><b> Flexibility and Efficiency</b></h3>
                        <p> As per your business requirements, you can decide what features you want to be included in the software product.</p>
                    </li>
                    <li>
                        <i class="icon2 wow bounceIn"></i>
                        <h3><b> Security </b></h3>
                        <p>Custom software application development gives you full control over what security technologies or protocols are integrated into your software.</p>
                    </li>
                    <li>
                        <i class="icon3 wow bounceIn"></i>
                        <h3><b> Cost-Effectiveness </b></h3>
                        <p>You can begin working on the most critical features and, depending on your budget, implement advanced features over time. </p>
                    </li>
                    <li>
                        <i class="icon4 wow bounceIn"></i>
                        <h3><b> Better Integration with Existing Systems </b></h3>
                        <p>The customized software application can easily be integrated with existing systems of yours and can be tailored to suit the skill level of users.</p>
                    </li>
                    <li>
                        <i class="icon5 wow bounceIn"></i>
                        <h3><b> Scalability </b></h3>
                        <p> Custom software application development allows you to ensure that your software scales to accommodate the growth of your business over time.</p>
                    </li>
                    <li>
                        <i class="icon6 wow bounceIn"></i>
                        <h3><b> Optimized Business Process </b></h3>
                        <p>Custom software development helps you optimize your business processes rather than replacing them.</p>
                    </li>
...
<section class="sectionPadd initiatives section-margin">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
        ...
        <div class="row excellence-row">
            ...
            <div class="col-sm-6 col-md-4">
                <div  class="chapter-solution-div">
                    ...
                    <p>We provide your business with a rich layer of custom-made logistics software solutions to ensure the seamless operation of your supply chain and network of distribution. As a leading custom software development provider reap the benefits of a modernized, customized and scalable logistics software solution to streamline your supply chain complexities.</p>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div  class="chapter-solution-div">
...
<section class="initiatives section-margin">
    <div class="container">
