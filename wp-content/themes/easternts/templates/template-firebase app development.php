    ...
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
                ...
                <p>Firebase is a framework rich in possibilities it has to offer for developers of the new age. With better quality, data storage and syncing facility, app marketing, user engagement and improved interface techniques. Firebase is slowly becoming a trendsetter to it's own kind.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-7 simpleSecutre text-justify">
                ...
                <div>
                    ...
                    <p>Firebase provides a customizable user interface, it also provides drop-in auth solution that handles the UI flows for authenticating users on mobile devices and websites.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p>Firebase is a back-end as a service, it receives many requests to your both real-time and firestore database & if anything found suspicious than firebase has security rules that you can write to lock-down your databases.</p>
                </div>
                <div>
                    <h4>Fast Implementation</h4>
                    <p>Firebase provides a set of security and authentication to your application without writing many complex queries & also handle complex cases like, account merging to ease your development.</p>
                </div>
            </div>
