...
<!-- Vuejs Development -->
<section class="sectionPaddequal ">
    <div class="container">
        <div class="row d-flex">
           ...
           <div class="col-md-6">
                <div class="fireAdd">
                    ...
                    <p>When aiming for top-notch performance, seamless user experience, and an engaging interface in a web application, the unparalleled combination of Laravel and Vue.js takes the lead. At Edventure Infotech, our adept developers harness the strengths of both frameworks to craft a comprehensive web application. For further details, please reach out to us at <a href="mailto: info@edventureinfotech.com">info@edventureinfotech.com</a>.</p>
                </div>
...
<!-- AngularJS -->
<section class="sectionPaddequal bg-orange">
    <div class="container">
        <div class="row d-flex">
