        ...
        <div class="row">
            <div class="col-md-4">
                <div class="gap-process text-center">
                    ...
                    <p>Hyperlink values quality and provides 100% bug free application with no compromisation in it.</p>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="a_mobile">
                        <div class="mobile_app_box">
                            ...
                            <p class="web_desc_para">We, as the most preferred app development company, always deliver the best support for clients. Our team of consultants and client care is set to help our clients with any unresolved queries or information. You can take or word for guaranteed maintenance.
                            </p>
                        </div>
                        <div class="icon_img">
                            <img src="../../wp-content/uploads/2023/02/affordable.webp" alt="affordable">
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="a_mobile">
                        <div class="mobile_app_box">
                            ...
                            <p class="web_desc_para">Perdiscoo runs by a standardized superior development methodology. It is why we can assure you the most efficient app with reliable features on or before the scheduled time. We also keep you informed about the progress in the development procedure.
                            </p>
                        </div>
                        <div class="icon_img">
...
<section class="sectionPadd">
    <div class="container ">
        <div class="row fireAdd ">
            ...
            <P>As a reputed PhoneGap App Development Company in Melbourne, we offer a vast range of custom PhoneGap App Development Services to a diverse business sector clientele. No matter is it a large enterprise, small-sized business or a newly launched startup.</P>
            <p>PhoneGap App Development services, we utilize the ultra-modern technologies and adhere require platform-specific standards so that final app would be approved on all App Stores rapidly. Being a top PhoneGap development company, our team of PhoneGap Development specialists has obtained an unparalleled level of expertise in Custom PhoneGap Development and can do everything related to PhoneGap Development under a limited budget and timeframe.</p>
        </div>
