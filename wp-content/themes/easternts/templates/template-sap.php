    ...
    <div class="container-fluid p0">
        <div class="row appFlex">
            <div class="col-md-6 p0">
                <img src="http://localhost/edventureinfotech/wp-content/uploads/2023/09/sap-1.webp"  class="wow fadeInLeft" data-wow-delay="0.2s"  data-wow-duration="3s" style="width: 951px;height: auto;" alt="ux1">
            </div>
...
<section class="">
    <div class="container-fluid p0">
        <div class="row appFlex">
            <div class="col-md-6 order2 p0">
                <img src="http://localhost/edventureinfotech/wp-content/uploads/2023/09/sap-2.webp" class="wow fadeInRight"  data-wow-delay="0.2s" data-wow-duration="3s" style="width: 951px;height: auto;" alt="ux2">
            </div>
            <div class="col-md-6 p0">
                <div class="zigZ">
