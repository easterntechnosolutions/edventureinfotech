...
<section class="sectionPadd" style="background: #f4f4f4;">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
                <h2>We understand your Product Development Challenges</h2>
                <p>Faster time to market with superior customer experience and continuous evolution in the midst of uncertainties are the most pressing concerns of disruptive product companies. Our company, Eastren Techno Solution, understands your challenges and works as a team to overcome them.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mt-5">
                <div class="it-consulti-address">
                    ...
                    <ul>
                        <li>Controlling excess development time </li>
                        <li>In-premise is dead, cloud is the new normal </li>
                        <li>User demand is ever rising </li>
                        <li>Dealing with continuously changing technologies </li>
            ...
            <div class="col-md-4 mt-5">
                <div class="it-consulti-address">
                    ...
                    <ul>
                        <li>Fast response to changes and quick action </li>
                        <li>Agile, DevOps and CICD led processes </li>
                        <li>Ability to cope up with sudden changes </li>
                        <li>In tune with trends such as IoT, AR/VR, artificial intelligence, and blockchain </li>
                        <li>Agile mindset and analysis-based decisions </li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- Our Software Product Development Domain Expertise -->
...
<section class="sectionPadd vue-technology-stack bg-orange">
    <div class="container">
        <div class="row">
            <div class="fireAdd  text-center">
                <h2>Our Core Custom Software Development Services </h2>
                <p>Intellectsoft provides an end-to-end software development service that adapts seamlessly to your project requirements and business requirements, from IT strategy consulting and comprehensive technology roadmaps.</p>
            </div>
        </div>
            ...
            <div class="items items--col-3">
                  <div class="item">
                        ...
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="92" height="63" viewBox="0 0 92 63" class="item__description-logo offer-image replaced-svg">
                  ...
                  <div class="item">
                        ...
                        <div class="item__link">
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" height="91" viewBox="0 0 91 91" width="91" class="item__description-logo offer-image replaced-svg">
                                    <g fill="none" fill-rule="evenodd">
                                    <path
                                          d="m81.91 91v-28zm-8.091-48c4.713 0 8.09-2.94 8.09-7.2v-3.6c0-4.26-3.375-7.2-8.09-7.2-4.716 0-8.092 2.94-8.092 7.2v3.6c0 4.26 3.375 7.2 8.092 7.2zm-64.729 48v-28zm8.09-48c-4.713 0-8.09-2.94-8.09-7.2v-3.6c0-4.26 3.375-7.2 8.09-7.2 4.716 0 8.092 2.94 8.092 7.2v3.6c0 4.26-3.375 7.2-8.092 7.2zm10.114-24c-4.715 0-8.09-2.94-8.09-7.2v-3.6c0-4.26 3.375-7.2 8.09-7.2 4.716 0 8.09 2.94 8.09 7.2v3.6c0 4.26-3.374 7.2-8.09 7.2zm36.41 0c-4.716 0-8.09-2.94-8.09-7.2v-3.6c0-4.26 3.374-7.2 8.09-7.2 4.715 0 8.09 2.94 8.09 7.2v3.6c0 4.26-3.375 7.2-8.09 7.2zm18.206 64c3.934 0 8.09-2.11 8.09-6v-18c0-6.607-11.88-10-18.203-10-.626 0-1.308.033-2.024.1m-60.683 33.9c-3.933 0-8.09-2.11-8.09-6v-18c0-6.607 11.88-10 18.203-10 .626 0 1.308.033 2.024.1"
                                          stroke="#323232"
                                    ></path>
                                    <path
                  ...
                  <div class="item">
                        ...
                        <div class="item__link">
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="92" height="85" viewBox="0 0 92 85" class="item__description-logo offer-image replaced-svg">
                                    <g fill="none" fill-rule="evenodd">
                  ...
                  <div class="item">
                        ...
                        <div class="item__link">
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="81" height="88" viewBox="0 0 81 88" class="item__description-logo offer-image replaced-svg">
                                    <defs><path id="a" d="M0 89.725h83V0H0z"></path></defs>
                  ...
                  <div class="item">
                        ...
                        <div class="item__link">
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" height="96" viewBox="0 0 90 96" width="90" class="item__description-logo offer-image replaced-svg">
                                    <g fill="none" fill-rule="evenodd">
                                    <path
                  ...
                  <div class="item">
                        ...
                        <div class="item__link">
                        <a href="javascript:void(0); ">
                              <svg xmlns="http://www.w3.org/2000/svg" width="92" height="68" viewBox="0 0 92 68" class="item__description-logo offer-image replaced-svg">
                                    <g fill="none" fill-rule="evenodd">
                                    <path
                                          stroke="#323232"
...
<section class="sectionPadd" style="background-color: #fff;">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
                <h2>Custom Software Development Lifecycle</h2>
                <p>We employ top-of-the-line practice processes and development methodologies as a foundation for the rapid building of cutting-edge technology solutions in a structured and methodical way.</p>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="accordion__item ">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                        <svg width="29" height="36" viewBox="0 0 29 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                <g id="MKTG-2887-Service-page" transform="translate(-240.000000, -1748.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                    <g id="planning" transform="translate(241.000000, 1749.000000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                        <path
                                            ...
                                            stroke-width="1.5px"
                                        ></path>
                                        <polygon id="Stroke-3" points="24.8788579 5.96983333 20.0030916 9.52819203 16.4447329 4.65242572 21.3204992 1.09406703" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <polygon id="Stroke-5" points="7.69385661 0.400805797 0.732572192 2.93526866 6.4179481 7.69861014" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <path
                    ...
                    <div class="accordion__content ">
                        <p class="">We collect all the relevant information from the customer to develop custom software development solutions as per their expectations.</p>
                    </div>
                </div>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex" >
                        <svg width="41" height="37" viewBox="0 0 41 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>designing</title>
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                <g id="MKTG-2887-Service-page" transform="translate(-234.000000, -1810.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                    <g id="designing" transform="translate(235.000000, 1811.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                        <path
                                            d="M5.90189,27.00161 C8.99334,31.24311 13.99899,33.99966 19.64979,33.99966 C29.03889,33.99966 36.64979,26.38876 36.64979,16.99966 L36.64979,16.14966 L38.34979,16.14966 L34.09979,10.19966 L30.69979,16.14966 L32.39979,16.14966 L32.39979,16.99966 C32.39979,20.36056 31.10014,23.41631 28.97599,25.69346"
                                            id="Stroke-1"
                                            stroke="#323232"
                                            fill="none"
                                            stroke-width="1.5px"
                                        ></path>
                                        <path
                                            d="M33.24962,6.99839 C30.15817,2.75689 25.15252,0.00034 19.50172,0.00034 C10.11262,0.00034 2.50172,7.61124 2.50172,17.00034 L2.50172,17.85034 L0.80172,17.85034 L5.05172,23.80034 L8.45172,17.85034 L6.75172,17.85034 L6.75172,17.00034 C6.75172,13.63944 8.05137,10.58369 10.17552,8.30654"
                                            id="Stroke-3"
                                            stroke="#323232"
                                            fill="none"
                                            stroke-width="1.5px"
                                        ></path>
                                        <polygon id="Stroke-5" points="26.44962 26.35 12.84962 26.35 12.84962 11.05 16.24962 7.65 26.44962 7.65" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <polyline id="Stroke-7" points="17.09962 9.35 17.09962 11.9 14.54962 11.9" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                    </g>
                                </g>
                            </g>
                        </svg>
                    ...
                    <div class="accordion__content">
                        <p>Documents and systems are prepared according to specifications. This helps us define the overall system architecture and technology stack. </p>
                    </div>
                </div>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                        <svg width="32" height="37" viewBox="0 0 32 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>Defining</title>
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                <g id="MKTG-2887-Service-page" transform="translate(-239.000000, -1872.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                    <g id="Defining" transform="translate(240.000000, 1873.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                        <polygon id="Stroke-1" points="14.7826087 18.4782609 8.86956522 14.7826087 14.7826087 11.0869565 20.6956522 14.7826087" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <polygon id="Stroke-2" points="24.3913043 27.3478261 19.9565217 24.3913043 24.3913043 21.4347826 28.826087 24.3913043" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <polygon id="Stroke-4" points="0.739130435 26.6086957 9.60869565 26.6086957 9.60869565 22.173913 0.739130435 22.173913" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                        <polyline id="Stroke-7" points="20.6956522 14.7826087 24.3913043 14.7826087 24.3913043 21.4347826" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                        <polyline id="Stroke-8" points="8.86956522 14.7826087 5.17391304 14.7826087 5.17391304 21.4347826" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                        <polyline id="Stroke-9" points="5.17391304 26.6086957 5.17391304 33.2608696 14.7826087 33.2608696 14.7826087 24.3913043 19.9565217 24.3913043" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                        <line x1="24.3913043" y1="27.3478261" x2="24.3913043" y2="34" id="Stroke-11" stroke="#323232" fill="none" stroke-width="1.5px"></line>
                                        <path
                                            d="M20.6956522,4.06521739 C20.6956522,5.90195652 18.048087,7.39130435 14.7826087,7.39130435 C11.5171304,7.39130435 8.86956522,5.90195652 8.86956522,4.06521739 C8.86956522,2.22847826 11.5171304,0.739130435 14.7826087,0.739130435 C18.048087,0.739130435 20.6956522,2.22847826 20.6956522,4.06521739 Z"
                                            id="Stroke-13"
                                            stroke="#323232"
                                            fill="none"
                                            stroke-width="1.5px"
                                        ></path>
                                        <line x1="14.7826087" y1="7.39130435" x2="14.7826087" y2="11.0869565" id="Stroke-15" stroke="#323232" fill="none" stroke-width="1.5px"></line>
                                    </g>
                                </g>
                            </g>
                        </svg>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                            <svg width="43" height="36" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>building</title>
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                    <g id="MKTG-2887-Service-page" transform="translate(-233.000000, -1934.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                        <g id="building" transform="translate(233.000000, 1935.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                            <path
                                                d="M24.1512737,14.3157895 C24.1512737,16.2922632 25.7537474,17.8947368 27.7302211,17.8947368 C29.7066947,17.8947368 31.3091684,16.2922632 31.3091684,14.3157895 C31.3091684,12.3393158 29.7066947,10.7368421 27.7302211,10.7368421 C25.7537474,10.7368421 24.1512737,12.3393158 24.1512737,14.3157895 Z"
                                                id="Stroke-1"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M33.4385526,23.3981737 L36.3813421,25.9114895 L39.3259211,22.9660158 L36.8126053,20.0241211 C37.4478684,19.0166474 37.9202895,17.8991211 38.1922895,16.7019632 L42.0468158,16.3986474 L42.0468158,12.2336474 L38.1922895,11.9303316 C37.9202895,10.7331737 37.4478684,9.61564737 36.8126053,8.60817368 L39.3259211,5.66538421 L36.3813421,2.72080526 L33.4385526,5.23322632 C32.4310789,4.59885789 31.3135526,4.12643684 30.1163947,3.85443684 L29.8130789,-8.94736842e-05 L25.6480789,-8.94736842e-05 L25.3447632,3.85443684 C24.1476053,4.12643684 23.0300789,4.59885789 22.0226053,5.23322632 L19.0798158,2.72080526 L16.1352368,5.66627895 L18.6476579,8.60817368 C18.0132895,9.61564737 17.5408684,10.7340684 17.2688684,11.9303316 L15.4275,12.0752789"
                                                id="Stroke-3"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M8.94119474,19.6842105 C6.82693158,19.6842105 5.36224737,17.9672105 5.36224737,15.8493684 L5.36224737,14.5707895 C5.36224737,12.4529474 6.82693158,10.7368421 8.94119474,10.7368421 C11.0554579,10.7368421 12.5201421,12.4529474 12.5201421,14.5707895 L12.5201421,15.8493684 C12.5201421,17.9672105 11.0554579,19.6842105 8.94119474,19.6842105 Z"
                                                id="Stroke-5"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M0.888563158,33.1052632 C0.888563158,33.1052632 1.47551053,28.1287368 1.7833,25.9473684 C2.09108947,23.766 3.39382632,22.3684211 5.36224737,22.3684211 L7.15172105,22.3684211 L13.3978789,29.5263158 L18.7663,29.5263158 C18.7663,29.5263158 19.1662474,33.1052632 16.0820895,33.1052632 L10.7306684,33.1052632 L6.25698421,27.7368421"
                                                id="Stroke-7"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <polyline id="Stroke-9" points="14.3096158 26.8421053 17.8885632 21.4736842 30.4148789 21.4736842 25.0464579 30.4210526 20.5727737 30.4210526" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <line x1="6.25698421" y1="33.1052632" x2="32.2043526" y2="33.1052632" id="Stroke-11" stroke="#323232" fill="none" stroke-width="1.5px"></line>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                    ...
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                            <svg width="41" height="37" viewBox="0 0 41 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>testing</title>
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                    <g id="MKTG-2887-Service-page" transform="translate(-234.000000, -1996.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                        <g id="testing" transform="translate(235.000000, 1997.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                            <polyline id="Stroke-1" points="24.65 29.75 24.65 34 14.45 34 14.45 24.65 22.1 24.65" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polyline id="Stroke-3" points="17 28.9 19.55 31.45 25.5 24.65" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polygon id="Stroke-4" points="28.9 34 39.1 34 39.1 24.65 28.9 24.65" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                            <polyline id="Stroke-6" points="10.2 29.75 10.2 34 0 34 0 24.65 7.65 24.65" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polyline id="Stroke-8" points="2.55 28.9 5.1 31.45 11.05 24.65" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <path
                                                d="M9.35,8.5 C7.34145,8.5 5.95,6.86885 5.95,4.85775 L5.95,3.64225 C5.95,1.63115 7.34145,0 9.35,0 C11.35855,0 12.75,1.63115 12.75,3.64225 L12.75,4.85775 C12.75,6.86885 11.35855,8.5 9.35,8.5 Z"
                                                id="Stroke-9"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M2.55,21.25 C2.55,21.25 3.1076,16.5223 3.4,14.45 C3.6924,12.3777 4.93,11.05 6.8,11.05 L8.5,11.05 L14.43385,17.85 L19.53385,17.85 C19.53385,17.85 19.9138,21.25 16.98385,21.25 L11.9,21.25 L7.65,16.15"
                                                id="Stroke-11"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <polyline id="Stroke-13" points="15.3 15.3 18.7 10.2 29.75 10.2 24.65 18.7 21.25 18.7" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <line x1="8.5" y1="21.25" x2="37.4" y2="21.25" id="Stroke-15" stroke="#323232" fill="none" stroke-width="1.5px"></line>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                            <svg width="33" height="37" viewBox="0 0 33 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>deployment</title>
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                    <g id="MKTG-2887-Service-page" transform="translate(-238.000000, -2058.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                        <g id="deployment" transform="translate(239.000000, 2059.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                            <path
                                                d="M12.2978723,30.3829787 C13.6028936,30.3829787 14.4680851,29.2725532 14.4680851,27.9031489 L14.4680851,27.0755745 C14.4680851,25.7061702 13.6028936,24.5957447 12.2978723,24.5957447 C10.9928511,24.5957447 10.1276596,25.7061702 10.1276596,27.0755745 L10.1276596,27.9031489 C10.1276596,29.2725532 10.9928511,30.3829787 12.2978723,30.3829787 Z"
                                                id="Stroke-1"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M4.34042553,31.8297872 C5.64544681,31.8297872 6.5106383,30.7193617 6.5106383,29.3499574 L6.5106383,28.522383 C6.5106383,27.1529787 5.64544681,26.0425532 4.34042553,26.0425532 C3.03540426,26.0425532 2.17021277,27.1529787 2.17021277,28.522383 L2.17021277,29.3499574 C2.17021277,30.7193617 3.03540426,31.8297872 4.34042553,31.8297872 Z"
                                                id="Stroke-3"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M16.6382979,34 L16.6382979,32.5531915 C16.6382979,30.7605957 13.8054468,30.3829787 12.2978723,30.3829787 C10.7902979,30.3829787 7.95744681,30.7605957 7.95744681,32.5531915 L7.95744681,34"
                                                id="Stroke-5"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M7.95780851,32.6877447 C7.01593617,32.0062979 5.36946809,31.8297872 4.34078723,31.8297872 C2.83321277,31.8297872 0.000361702128,32.2074043 0.000361702128,34"
                                                id="Stroke-7"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M20.2553191,31.8297872 C18.9502979,31.8297872 18.0851064,30.7193617 18.0851064,29.3499574 L18.0851064,28.522383 C18.0851064,27.1529787 18.9502979,26.0425532 20.2553191,26.0425532 C21.5603404,26.0425532 22.4255319,27.1529787 22.4255319,28.522383 L22.4255319,29.3499574 C22.4255319,30.7193617 21.5603404,31.8297872 20.2553191,31.8297872 Z"
                                                id="Stroke-9"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M16.6382979,32.6877447 C17.5794468,32.0062979 19.2266383,31.8297872 20.2553191,31.8297872 C21.7628936,31.8297872 24.5957447,32.2074043 24.5957447,34"
                                                id="Stroke-11"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ...
                                            ></path>
                                            <path
                                                d="M14.4680851,20.2553191 C14.4680851,21.454 15.439617,22.4255319 16.6382979,22.4255319 L23.1489362,22.4255319 L26.2168936,26.0042128 C26.6538298,26.5142128 27.4893617,26.2053191 27.4893617,25.534 L27.4893617,22.4255319 L28.9361702,22.4255319 C30.1348511,22.4255319 31.106383,21.454 31.106383,20.2553191 L31.106383,7.23404255 C31.106383,6.0353617 30.1348511,5.06382979 28.9361702,5.06382979 L24.5957447,5.06382979"
                                                id="Stroke-15"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <path
                                                d="M14.5012894,9.38768936 C14.5012894,10.5950511 13.5218,11.5745404 12.3144383,11.5745404 C11.1070766,11.5745404 10.1275872,10.5950511 10.1275872,9.38768936 C10.1275872,8.18032766 11.1070766,7.2008383 12.3144383,7.2008383 C13.5218,7.2008383 14.5012894,8.18032766 14.5012894,9.38768936 Z"
                                                id="Stroke-17"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                ...
                <div class="accordion__item">
                    <button class="accordion__btn">
                        <span class="accordion__caption sddl-flex">
                            <svg width="34" height="37" viewBox="0 0 34 37" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>maintenance</title>
                                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round">
                                    <g id="MKTG-2887-Service-page" transform="translate(-239.000000, -2120.000000)" stroke="#323232" stroke-width="1.5px" fill="none">
                                        <g id="maintenance" transform="translate(240.000000, 2121.500000)" stroke="#323232" fill="none" stroke-width="1.5px">
                                            <path
                                                d="M13.7446809,17.3617021 C13.7446809,18.560383 14.7162128,19.5319149 15.9148936,19.5319149 C17.1135745,19.5319149 18.0851064,18.560383 18.0851064,17.3617021 C18.0851064,16.1630213 17.1135745,15.1914894 15.9148936,15.1914894 C14.7162128,15.1914894 13.7446809,16.1630213 13.7446809,17.3617021 Z"
                                                id="Stroke-1"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ...
                                            ></path>
                                            <path
                                                d="M20.9787234,3.61702128 C20.9787234,2.01902128 22.2743404,0.723404255 23.8723404,0.723404255 C25.4703404,0.723404255 26.7659574,2.01902128 26.7659574,3.61702128 C26.7659574,5.21502128 25.4703404,6.5106383 23.8723404,6.5106383 C22.2743404,6.5106383 20.9787234,5.21502128 20.9787234,3.61702128 Z"
                                                id="Stroke-5"
                                                stroke="#323232"
                                                fill="none"
                                                stroke-width="1.5px"
                                            ></path>
                                            <polyline id="Stroke-7" points="20.9787234 3.61702128 15.9148936 3.61702128 15.9148936 7.23404255" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polygon id="Stroke-9" points="28.212766 23.1489362 31.8297872 26.7659574 28.212766 30.3829787 24.5957447 26.7659574" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                            <polygon id="Stroke-11" points="2.89361702 29.6595745 8.68085106 33.2765957 8.68085106 26.0425532" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                            <polygon id="Stroke-13" points="0.723404255 10.8510638 6.5106383 10.8510638 6.5106383 5.06382979 0.723404255 5.06382979" stroke="#323232" fill="none" stroke-width="1.5px"></polygon>
                                            <polyline id="Stroke-15" points="25.3191489 17.3617021 28.212766 17.3617021 28.212766 23.1489362" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polyline id="Stroke-16" points="6.5106383 17.3617021 3.61702128 17.3617021 3.61702128 10.8510638" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                            <polyline id="Stroke-17" points="15.9148936 27.4893617 15.9148936 30.3829787 8.68085106 30.3829787" stroke="#323232" fill="none" stroke-width="1.5px"></polyline>
                                        </g>
                                    </g>
                                </g>
                            </svg>
                    ...
                    <div class="accordion__content">
                        <p>According to the service level agreement, we ensure that needs continue to be met. We also ensure that the system continues to perform as per the specification mentioned in the first phase. </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="fireAdd">
                    ...
                    <p>Our company offers a wide range of software development services to meet the needs of various industries. Having a diverse range of expertise is crucial for a software development firm. This is because it allows it to be able to effectively serve clients from different sectors. In order to deliver high-quality software solutions, it's also paramount for a company to have a solid understanding of the specific needs and challenges faced by each industry, as well as the latest trends and technologies in the field. Additionally, having a strong project management process in place can help ensure that projects are completed on time and within budget. This will enable them to meet the requirements and expectations of the client.</p>
                </div>
            </div>  
                ...
                <li class="services-process__items">
                    <div class="services-process__icon">
                        <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg" class="services-process__svg">
                            ...
                            <defs>
                                <clipPath id="clip5"><path fill="#fff" d="M0 0h63v63H0z"></path></clipPath>
                            </defs>
                        </svg>
                    </div>
                    <div class="services-process__body">
                        <span class="services-process__heading">3. Delivery and Reporting</span>
                        <div class="services-process__text"><p>We will provide you with reports at each stage of your project development, ensuring everything proceeds as planned.</p></div>
                    </div>
                </li>
                <li class="services-process__items">
                    <div class="services-process__icon">
...
<section class="sectionPadd vue-technology-stack ">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
                <h2>Technology Stack</h2>
                <p>We employ cutting-edge technologies and tools to make sure your applications are built on the latest technology. Have a look at our tech stack.</p>
            </div>
        </div>
        <div class="row">
                ...
                <div class="vue-technology-stack-card card-technology">
                    ...
                    <div class="row mt-3 tech-names">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0">CoreData</p>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-0">Realm</p>
                ...
                <div class="vue-technology-stack-card card-technology">
                    ...
                    <div class="row mt-3 tech-names">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0">Jenkins</p>
                            <p class="mb-0">Kubernetes</p>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-0">Google Cloud</p>
                            <p class="mb-0">Docker</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="vue-technology-stack-card card-technology">
                    ...
                    <div class="row mt-3 tech-names">
                        <div class="col-md-6">
                            <p class="mb-0">Appium</p>
                            <p class="mb-0">BrowserStack</p>
                        </div>
                        <div class="col-md-6 px-0">
                            <p class="mb-0">Katalon Test Studio</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="vue-technology-stack-card card-technology">
                    ...
                    <div class="row mt-3 tech-names">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0">Asana</p>
                        </div>
                        <div class="col-md-6 pr-0">
                            <p class="mb-0">Microsoft Teams</p>
                            <p class="mb-0">Trello</p>
