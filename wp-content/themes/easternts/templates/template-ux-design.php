                ...
                <div class="serimg">
                    <div class="sercon ">
                        <div class="text-start container">
                            <h1>UX Design</h1>
                            <p>The best of functionality and visual appeal</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="">
    <div class="container-fluid p0">
        <div class="row appFlex">
            <div class="col-md-6 order2 p0">
                <img src="../../wp-content/uploads/2023/09/ux-2.png" class="wow fadeInRight"  data-wow-delay="0.2s" data-wow-duration="3s" style="width: 951px;height: auto;" alt="ux2">
            </div>
            <div class="col-md-6 p0">
                <div class="zigZ">
...
<section class="">
    <div class="container-fluid p0">
        <div class="row appFlex">
            <div class="col-md-6 p0">
                <img src="../../wp-content/uploads/2023/09/ux-3.png"  class="wow fadeInLeft" data-wow-delay="0.4s"  data-wow-duration="3s" style="width: 951px;height: auto;" alt="ux3">
            </div>
            <div class="col-md-6 order2  p0">
                <div class="zigZ">
...
<section class="">
    <div class="container-fluid p0">
        <div class="row appFlex">
            <div class="col-md-6 order2 p0">
                <img src="../../wp-content/uploads/2023/09/ux-4.png" class="wow fadeInRight" data-wow-delay="0.4s"  data-wow-duration="3s" style="width: 951px;height: auto;" alt="ux4">
            </div>
            <div class="col-md-6 p0">
                <div class="zigZ">
...
<section class="sectionPadd">
    <div class="container">
        <div class="row featureTheWe">
            <div class="OurServices mb0 text-center">
                <h2>Features That We Provide In Apps</h2>
            </div>
        </div>
        <div class="row">
...
<section class="ucuidevbg">
    <div class="container">
        <div class="row">
            <div class="fireAdd text-center">
                <h2>UX/UI Development Offerings</h2>
            </div>
        </div>
        <div class="row ">
            <div class="col-md-6">
                <div class="uxOffer">
                    <button class="tablinks" onclick="openCity(event, 'Real-time')" id="defaultOpen">UX/UI RESEARCH & ANALYSIS</button>
                    <button class="tablinks" onclick="openCity(event, 'NoSQL')">HUMAN FACTORS ANALYSIS</button>
                    <button class="tablinks" onclick="openCity(event, 'Serverless')">WIRE FRAMES & PROTOTYPES</button>
                    <button class="tablinks" onclick="openCity(event, 'Offline')">USER EXPERIENCE DESIGN</button>
                    <button class="tablinks" onclick="openCity(event, 'Globally')">ATTRACTIVE FRONT-END DESIGNS</button>
                    <button class="tablinks" onclick="openCity(event, 'Security')">USER EXPERIENCE EVALUATION</button>
                </div>
            </div>
